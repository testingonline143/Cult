    ...
    <section id="process" className="py-16 sm:py-20 bg-background">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-black text-foreground tracking-tight leading-[1.1] max-w-[500px]">
            Stranger to <span className="neon-text">cult member</span> in minutes
          </h2>
        </motion.div>
