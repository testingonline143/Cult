...
const SEED_CLUBS = [
  ...
  },
  {
    ...
    description: "Photography walks around Tirupati's temples, markets, and nature. Phone cameras to DSLRs welcome. Monthly photo challenges and exhibitions at local cafes.",
